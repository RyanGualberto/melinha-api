...
-- DropForeignKey
ALTER TABLE "product_variants" DROP CONSTRAINT "product_variants_productVariantCategoryId_fkey";
...
-- AddForeignKey
ALTER TABLE "product_variants" ADD CONSTRAINT "product_variants_productVariantCategoryId_fkey" FOREIGN KEY ("productVariantCategoryId") REFERENCES "product_variant_categories"("id") ON DELETE CASCADE ON UPDATE CASCADE;
